  ...
  <div class="modal-card">
    ...
    <section class="modal-card-body">
      ...
      <div class="field">
        ...
        <div class="control" :class="{'is-danger': errors.phone}">
          <input class="input" type="number" placeholder="Phone no" v-model="list.phone">
        </div>
      ...
      <div class="field">
        ...
        <div class="control" :class="{'is-danger': errors.email}">
